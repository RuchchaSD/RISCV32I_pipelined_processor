...
module Instruction_memory#(
    ...
    always_ff @(negedge rst) begin
        if(!rst) begin
            ...
            imem[11] = 32'h000162B7; // LUI
            imem[12] = 32'h00019317; // AUIPC
            imem[40] = 32'h033103E7; // JALR
            imem[14] = 32'hFF710213; // ADDI
            ...
            imem[23] = 32'h00810583; // LB
            imem[24] = 32'h00811603; // LH
            imem[25] = 32'h00812683; // LW
            imem[26] = 32'h00814703; // LBU
            imem[27] = 32'h00815783; // LHU
