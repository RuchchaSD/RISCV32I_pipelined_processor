...
module RISCV32I_pipelined#(
    ...
    input logic rst,    
    //initiations
    output logic [31:0] PC_in_if_id,
    output logic [31:0] memOut_out_mem_wb,
    output logic [31:0] aluOut_in_ex_mem
...
//Ex stage declerations
    ...
    logic [31:0] dataMWrite_in_ex_mem;
...
//MemStage declerations
    ...
    logic [31:0]  writeData_in_mem_wb, writeData_out_mem_wb;
...
//Wbstage ports
    ...
    logic flush_in_if_id, branch_out_id, temp;
    
    //assign temp = (flush_if_id || rst) ? 1'b1 : 1'b0;

//If stage 
    // IF_stage IF_stage_inst(clk, rst, pcSel_out_id, jmpAddress_out_id, instruction_in_if_id, PC_in_if_id, PC4_in_if_id);
    IF_stage IF_stage_inst(clk,rst, flush_if_id,branch_out_id, pcSel_out_id, jmpAddress_out_id,flush_in_if_id, instruction_in_if_id, PC_in_if_id, PC4_in_if_id);
