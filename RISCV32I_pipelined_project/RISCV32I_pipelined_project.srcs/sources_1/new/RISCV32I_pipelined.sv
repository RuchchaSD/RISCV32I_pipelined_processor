...
module RISCV32I_pipelined#(
    ...
    input logic rst,    
    //initiations
    logic [ADDRESS_LENGTH-1:0] pc_in_if_id, pc4_in_if_id,instruction_in_if_id, 
                               pc_out_if_id, pc4_out_if_id,instruction_out_if_id,
                               branchAddress, 
    logic [1:0] pcSel,
    logic stall_if_id 
    );
...
//IF stage ports
    ...
    flush_ex_mem, memRead_in_ex_mem, memWrite_in_id_ex,stall_mem_wb, flush_mem_wb, wbMuxSel_in_ex_mem;
...
//ID Stage initiations
    ...
    logic ALUSrc1_out_id_ex, ALUSrc2_out_id_ex,   memWrite_out_id_ex, regWrite_out_id_ex, wbMuxSel_out_id_ex;
    logic [3:0] ALUOp_out_id_ex;
    logic [3:0] PCSrc,ALUSrc1,ALUSrc2,ALUOp;
    logic [2:0] memRead_out_id_ex,func3_out_id_ex;
    logic [2:0] Func3;
    logic [6:0] func7_out_id_ex;
    logic [6:0] Func7;
    logic [4:0] readReg1_out_id_ex, readReg2_out_id_ex,dataRegWrite_in_ex_mem;
...
//Ex stage declerations
    logic  regWrite_in_ex_mem, wbMuxSel_out_ex_mem,controlMRead_in_ex_mem,memToReg_in_ex_mem;
    logic [2:0] memRead_out_ex_mem,controlMWrite_in_ex_mem;
    logic [31:0] aluOut_in_ex_mem,dataMWrite_in_ex_mem;
    
    logic controlMRead_out_ex_mem,memToReg_out_ex_mem, regWrite_out_ex_mem;
    logic [2:0] controlMWrite_out_ex_mem;
...
//MemStage declerations
    ...
    logic [4:0] dataRegWrite_in_mem_wb;                                                                                                               
    ...
    logic [4:0] dataRegWrite_out_mem_wb;
...
//EXE-MEM latch
    ...
    controlMRead_out_ex_mem,controlMWrite_out_ex_mem,memToReg_out_ex_mem, regWrite_out_ex_mem, aluOut_out_ex_mem,dataMWrite_out_ex_mem,writeReg_out_mem_wb);
...
//MEM-WB latch
    always_comb begin
        ...
        dataRegWrite_in_mem_wb = writeReg_out_mem_wb;
    end
